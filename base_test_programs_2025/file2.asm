...
neg_and_done:
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002AD7F70
    ...
    mov eax, 1
LABEL@AFTER_THEN_0000000002AD7F70:

    ;"else" (part of "elseif")
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_0000000002ADA0B0
    ...
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002ADCE68
    ...
    mov eax, 1
LABEL@AFTER_ELSE_0000000002ADA0B0:
LABEL@AFTER_THEN_0000000002ADCE68:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_0000000002ADEFA8
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_0000000002ADEFA8:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002AE6C58
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_0000000002AE6C58:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_0000000002AE8970
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_0000000002AE8970:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002AEE4E0
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_0000000002AEE4E0:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_0000000002AF01F8
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_0000000002AF01F8:
    ...
    ;after cond expresion (after "if")
    cmp eax, 0
    jz LABEL@AFTER_THEN_0000000002AF48A0
    ...
    ;";" (after "then"-part of if-operator)
    mov eax, 1
LABEL@AFTER_THEN_0000000002AF48A0:

    ;"else"
    cmp eax, 0
    jnz LABEL@AFTER_ELSE_0000000002AF65B8
    ...
    ;";" (after "else")
LABEL@AFTER_ELSE_0000000002AF65B8:
