...
LABEL@WHILE_0000000002AD6258:
    ...
    cmp eax, 0
    jz LABEL@AFTER_WHILE_0000000002AD6258
    ...
    ;end of while
    jmp LABEL@WHILE_0000000002AD6258
LABEL@AFTER_WHILE_0000000002AD6258:
...
LABEL@WHILE_0000000002AE1510:
    ...
    ;after cond expresion (after "while")
    cmp eax, 0
    jz LABEL@AFTER_WHILE_0000000002AE1510
...
LABEL@WHILE_0000000002AE5368:
    ...
    ;after cond expresion (after "while")
    cmp eax, 0
    jz LABEL@AFTER_WHILE_0000000002AE5368
    ...
    ;end of while
    jmp LABEL@WHILE_0000000002AE5368
LABEL@AFTER_WHILE_0000000002AE5368:
    ...
    ;end of while
    jmp LABEL@WHILE_0000000002AE1510
LABEL@AFTER_WHILE_0000000002AE1510:
